...
async function resetForgotPassword(e)
{
    ...
    const waitForSendingToBackend=await axios.post('http://18.181.246.36:3000/password/forgotpassword',email)
    ...
    if(waitForSendingToBackend.status===200)
    {
        ...
        const waitForResetingPassword=await axios.get(`http://18.181.246.36:3000/reset/password/${waitForSendingToBackend.data}`)
